    ...
    <div class="search-bar">
        <form method="POST" action="protected.php">
            ...
            <input type="text" name="txttitre"
                value="<?php echo isset($_POST["txttitre"]) ? $_POST['txttitre'] : "" ?>" />

            <label for="actor-input">Acteur :</label>
            <input type="text" name="txtact" value="<?php isset($_POST["txtact"]) ? $_POST['txtact'] : "" ?>" />

            <label for="director-input">Réalisateur :</label>
            <input type="text" name="txtreal" value="<?php isset($_POST["txtreal"]) ? $_POST['txtreal'] : "" ?>" />
