...
<div class='liste-film'>
    ...
    { ?>
        <!-- Affichage des films correspondants à la recherche
        // Lors du clic sur un film, le formulaire est envoyé vers gestionProjection.php -->
        ...
        <form id='form_<?php echo $uneligne["nofilm"]?>' method='post' action='gestionProjection.php'>
